...
_SSD_MASKHEAD.fields_by_name['conv_hyperparams'].message_type = hyperparams__pb2._HYPERPARAMS
...
_SSDFEATUREEXTRACTOR.fields_by_name['fpn'].message_type = fpn__pb2._FEATUREPYRAMIDNETWORKS
_SSDFEATUREEXTRACTOR.fields_by_name['bifpn'].message_type = fpn__pb2._BIDIRECTIONALFEATUREPYRAMIDNETWORKS
