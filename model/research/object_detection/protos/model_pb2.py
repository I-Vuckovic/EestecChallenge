...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[center__net__pb2.DESCRIPTOR,faster__rcnn__pb2.DESCRIPTOR,ssd__pb2.DESCRIPTOR,])
...
_DETECTIONMODEL.fields_by_name['center_net'].message_type = center__net__pb2._CENTERNET
