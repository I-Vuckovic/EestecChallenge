...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[box__coder__pb2.DESCRIPTOR,matcher__pb2.DESCRIPTOR,region__similarity__calculator__pb2.DESCRIPTOR,])
...
_TARGETASSIGNER.fields_by_name['matcher'].message_type = matcher__pb2._MATCHER
_TARGETASSIGNER.fields_by_name['similarity_calculator'].message_type = region__similarity__calculator__pb2._REGIONSIMILARITYCALCULATOR
_TARGETASSIGNER.fields_by_name['box_coder'].message_type = box__coder__pb2._BOXCODER
...
TargetAssigner = _reflection.GeneratedProtocolMessageType('TargetAssigner', (_message.Message,), {
  ...
  '__module__' : 'target_assigner_pb2'
